const preloads: Record<string, () => Promise<unknown>> = {
  ...
  "/console/languages": () => import("./pages/MerchantLanguagesPage"),
  "/console/inventory": () => import("./pages/InventoryPage"),
  "/console/supply-chain": () => import("./pages/SupplyChainPage"),
  ...
  "/console/tasks": () => import("./pages/TaskRecordsPage"),
  "/console/quotes/workbench": () => import("./pages/QuoteWorkbenchPage"),
  ...
  "/console/storefront": () => import("./pages/StorefrontManagementPage"),
  "/console/storefront/brand": () => import("./pages/AccountSettingsPage"),
  "/console/system/monitoring": () => import("./pages/SystemMonitoringPage"),
  "/console/system/usage": () => import("./pages/PlatformUsageAnalyticsPage"),
  "/console/system/configuration": () => import("./pages/ConfigurationCenterPage"),
  "/console/platform/translations": () => import("./pages/LanguagePackagesPage"),
