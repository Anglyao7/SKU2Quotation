...
const english: Record<string, string> = {
  ...
  "设置三个常用问题，它们会显示在公开商品目录的“查找商品”下面。":
    "Set three common questions to show below “Find products” in the public catalog.",
  ...
  "请填写三个推荐问题。": "Please fill in all three recommended questions.",
  "三个推荐问题不能重复。": "The three recommended questions must be different.",
  ...
  "创建后，对方使用账号密码登录代理商门户，只能浏览商品并提交自己的订单申请。":
    "After creation, the reseller signs in to the portal with this account and password. They can only browse products and submit their own order requests.",
  "代理商名称": "Reseller name",
  ...
  "正在打开代理商门户": "Opening reseller portal",
  "客户门户加载失败": "Could not load customer portal",
  "代理商工作台": "Reseller workspace",
  "代理商工作台加载失败": "Could not load the reseller workspace",
  "正在读取代理商工作台": "Loading reseller workspace",
  ...
  "此工作台只展示已经应用代理规则后的价格；供应商、原始价格、平台配置等内部信息不会向子账号开放。":
    "This workspace only shows prices after reseller rules are applied. Suppliers, original prices, and platform configuration are not available to subaccounts.",
