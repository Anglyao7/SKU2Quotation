...
const english: Record<string, string> = {
  "{days} 天": "{days} days",
  "按供应商制作采购单": "Create purchase orders by supplier",
  "采购单保存失败": "Could not save purchase order",
  "采购单号": "Purchase order number",
  "采购单号不能为空。": "Purchase order number is required.",
  "采购单日期不能为空。": "Purchase order date is required.",
  "采购单商品名称、SKU、数量和单位必须填写完整。": "Product name, SKU, quantity, and unit are required for every purchase-order line.",
  "采购单下载失败": "Could not download purchase order",
  "采购单已保存。": "Purchase order saved.",
  "采购价": "Purchase cost",
  "当前 SKU 尚未关联供应商。": "No supplier is linked to this SKU yet.",
  "导出 Excel": "Export Excel",
  "供应商 / Excel 工作表": "Suppliers / Excel worksheets",
  "供应商货号": "Supplier item number",
  "供应商与采购信息": "Supplier and purchasing information",
  "价格有效性": "Price validity",
  "交期 {days} 天": "Lead time: {days} days",
  "每个供应商会导出为一个独立的 Excel 工作表，商品与采购数据均可继续编辑。": "Each supplier is exported to a separate Excel worksheet, with editable product and purchasing data.",
  "日期": "Date",
  "未录入": "Not entered",
  "未填写联系人": "No contact provided",
  "未指定 / 手工填写": "Unassigned / enter manually",
  "未指定供应商": "Unassigned supplier",
  "正在读取供应商与采购信息": "Loading supplier and purchasing information",
  "Excel 预览": "Excel preview",
  "商品排序": "Product ordering",
  "手动优先 → 自动爆款 → 优先分类 → 其余商品": "Manual priority → Automatic bestsellers → Priority categories → Other products",
  "近 90 天热度前 {count} 个商品自动设为优先；可在下方取消或追加。": "The top {count} products by popularity over 90 days are automatically prioritized; remove or add products below.",
  "取消的自动优先会被记住；关闭此功能保留手动优先。": "Removed automatic priorities are remembered; turning this off keeps manual priorities.",
  "优先分类": "Priority categories",
  "只调整全部商品中的顺序，包含子分类和额外关联分类，不改变分类导航。": "Only affects All products, including subcategories and additional category memberships. Category navigation stays unchanged.",
  "添加优先分类": "Add priority category",
  "移除": "Remove",
  "尚未设置优先分类": "No priority categories set",
  "商品优先顺序": "Product priority order",
  "与前台全部商品使用同一排序；自动爆款已勾选，可直接调整。": "Uses the same ordering as All products. Automatic bestsellers are already selected and can be adjusted.",
  "自动爆款": "Automatic bestseller",
  "已取消自动优先": "Automatic priority removed",
  "移动分类": "Move categories",
  "移动后仅保留本次选中的分类。": "Only the categories selected here will remain after moving.",
  "已将 {products} 个商品移至 {categories} 个分类。": "Moved {products} products to {categories} categories.",
  "前往多证工作台": "Open document workbench",
  "请完善额外信息的标题和内容。": "Complete the title and content of the additional information.",
  "部分任务暂时无法读取": "Some tasks could not be loaded",
  "当前商家的最近任务；索引与每种语言展示最近一次任务。": "Recent tasks for this shop; the latest indexing task and task for each language are shown.",
  "当前展示最近 500 条询价": "Showing the latest 500 inquiries",
  "导出商品与 SKU": "Export products and SKUs",
  "店铺设置": "Store settings",
  "更多商品操作": "More product actions",
  "共 {count} 条": "{count} records",
  "结束日期": "End date",
  "进度": "Progress",
  "开始日期": "Start date",
  "客服入口": "Support entry points",
  "客户询价": "Customer inquiries",
  "客户询价暂时无法读取，请重试。": "Customer inquiries could not be loaded. Please retry.",
  "历史报价": "Previous quotations",
  "没有匹配的分类": "No matching categories",
  "匹配结果": "Matching results",
  "请确认数量和价格。": "Please confirm the quantity and price.",
  "任务": "Task",
  "任务记录": "Task records",
  "任务状态": "Task status",
  "商品与价格": "Products and pricing",
  "上架所选商品？": "Publish selected products?",
  "手动新建询价": "Create inquiry manually",
  "搜索单号、客户或国家": "Search number, customer or country",
  "搜索分类": "Search categories",
  "搜索任务": "Search tasks",
  "添加到分类": "Add to categories",
  "下架所选商品？": "Unpublish selected products?",
  "修改记录": "Change history",
  "修改原因": "Reason for change",
  "页面与展示": "Pages and display",
  "已确认并下发": "Confirmed and sent",
  "已选 {products} 个商品 · {skus} 个 SKU": "{products} products selected · {skus} SKUs",
  "暂无记录": "No records",
  "暂无任务": "No tasks",
  "暂无询价": "No inquiries",
  "只读": "Read only",
  "有未保存的修改": "Unsaved changes",
  "离开会丢弃未保存的内容。": "Leaving will discard unsaved changes.",
  ...
  "主图": "Main image",
  "商品图片列表": "Product image list",
  "商品图片 {current}/{count}": "Product image {current}/{count}",
  "查看图片 {index}": "View image {index}",
  ...
  "松开即可替换当前图片": "Drop to replace the selected image",
  "松开即可上传商品图片": "Drop to upload the product image",
  "选择缩略图后可直接替换": "Select a thumbnail to replace that image",
  "正在上传新图片…": "Uploading the new image…",
  "下载图片": "Download image",
  "替换图片": "Replace image",
  "新增图片": "Add image",
  "{count} 张": "{count} images",
  "商品图片已新增。": "Product image added.",
  "商品图片已删除。": "Product image deleted.",
  "商品图片删除失败": "Could not delete the product image",
  "确认删除这张商品图片？": "Delete this product image?",
  "暂未上传商品图片": "No product images uploaded",
  "每个商品最多上传 50 张图片。": "Each product can have up to 50 images.",
  ...
  "已复制": "Copied",
  "打开预览": "Open preview",
  "下载二维码名片": "Download QR card",
  "商品分享二维码": "Product share QR code",
  "二维码分享名片预览": "QR share card preview",
  "共 {count} 件商品": "{count} products",
  "{count} 件商品精选": "{count} selected products",
  "正在生成专属分享链接…": "Creating your share link…",
  "分享链接生成失败，请稍后重试。": "Could not create the share link. Please try again.",
  "无法复制链接，请手动选择链接复制。": "Could not copy the link. Select and copy it manually.",
  "分享名片生成失败，请稍后重试。": "Could not create the share card. Please try again.",
  "分类管理": "Categories",
  "分类": "Categories",
  "全部商品": "All products",
  ...
  "上传商品明细区域的 Excel 样式并映射列。最终报价单的商家、单号、客户与日期等顶部信息由系统统一生成。":
    "Upload and map an Excel product-table layout. Merchant, quote number, customer, date, and other document metadata are always generated by the system.",
  ...
  "上传包含商品表头和示例行的 .xlsx，系统会识别列并保留商品区域样式。":
    "Upload an .xlsx with product headers and a sample row. The system will detect its columns and preserve the product-region styling.",
  ...
  "重新识别": "Detect again",
  "列映射": "Column mapping",
  "商品区域列映射": "Product-region column mapping",
  ...
  "模板只控制商品明细区域；商家、单号、客户、日期与币种等顶部信息由系统统一生成。未映射列会保持为空。":
    "The template controls only the product-detail region. Merchant, quote number, customer, date, currency, and other header data are generated by the system; unmapped columns remain blank.",
  ...
  "未命名字段": "Unnamed field",
  "请填写自定义字段名称。": "Enter a name for every custom field.",
  "自定义字段名称不能重复。": "Custom field names must be unique.",
  ...
  "报价单设置": "Quotation settings",
  "编辑报价单": "Edit quotation",
  "报价单工作台": "Quotation workspace",
  "额外信息": "Additional information",
  "显示在整张报价单的商品列表下方": "Shown below the complete product list",
  "左侧设置报价单编号、模板、可见列、语言和样式。": "Use the left panel to set the quotation number, template, visible columns, language, and style.",
  "商品表格列可在左侧设置，空值会保留为空。": "Choose product table columns on the left; empty values stay blank.",
  "额外信息会显示在整张商品列表下方。": "Additional information appears below the complete product list.",
  ...
  "实时参考": "Live reference",
  "管理时区": "Manage time zones",
  "可添加或移除首页显示的主要市场时区。": "Add or remove the major market time zones shown on the dashboard.",
  "添加时区": "Add a time zone",
  "保存失败": "Could not save",
  "移除时区": "Remove time zone",
  ...
  "客户备注": "Customer notes",
  "客户填写信息": "Customer information",
  "整单备注": "Order note",
  "客户商品备注": "Customer product note",
  "产品中心": "Product center",
  ...
  "热门商品优先展示": "Prioritize bestsellers",
  "热门商品设置保存失败，请重试。": "Could not save bestseller settings. Please try again.",
  ...
  "我的询价": "My inquiries",
  "去商品前台": "Open storefront",
  "处理报价": "Process quote",
  "查看并处理由当前代理商前台提交的全部报价。": "View and process quotes submitted through your storefront.",
  "在商品前台选择商品并提交后，记录会显示在这里。": "Inquiries submitted through the storefront will appear here.",
  "待处理": "Pending",
  ...
  "客户前台": "Customer storefront",
  "前台管理": "Storefront management",
  "前台": "Storefront",
  "前台管理功能": "Storefront management features",
  "页面与导航": "Pages & navigation",
  "商品展示": "Product display",
  "页脚与联系": "Footer & contact",
  "统一管理客户在商品前台看到的商家品牌内容、导航与联系入口。":
    "Manage the merchant branding, navigation, and contact entries customers see across the storefront.",
  "商品首页": "Catalog home",
  "商品展示与排序": "Product display & ordering",
  "控制默认商品列表的排序方式，并手动指定需要优先展示的商品。":
    "Control the default catalog order and manually choose products to prioritize.",
  ...
  "人工编辑": "Manual merchandising",
  "手动优先商品": "Manually prioritized products",
  "搜索并开启商品右侧的开关，该商品会覆盖自动热度并优先出现在前台。":
    "Search for a product and enable its switch to override automatic popularity and show it first.",
  "搜索可优先展示的商品": "Search products to prioritize",
  "商品展示清单加载失败": "Could not load the storefront product list",
  "正在加载商品清单": "Loading product list",
  "暂无可展示商品": "No storefront products",
  "请更换商品名称或产品编码后重试。": "Try another product name or product code.",
  "商品上架后会出现在这里。": "Published products will appear here.",
  "商品已加入手动优先": "Product added to manual priority",
  "商品已取消手动优先": "Product removed from manual priority",
  "商品优先顺序保存失败": "Could not save the product priority",
  "手动优先": "Manual priority",
  "已优先": "Prioritized",
  "设为优先": "Prioritize",
  "设置商品 {name} 的前台优先状态": "Set storefront priority for {name}",
  "第 {page} / {pages} 页 · 共 {total} 个商品": "Page {page} of {pages} · {total} products",
  "商品区始终是第一个入口；你可以上传独立 HTML 页面，并为每个路由单独控制实时汇率等页面组件。":
    "The catalog remains the first entry. Upload standalone HTML pages and control components such as live exchange rates independently for each route.",
  "实时汇率": "Live exchange rates",
  "仅在当前路由显示": "Only on this route",
  "导航显示": "Show in navigation",
  "商品首页是否显示实时汇率": "Show live exchange rates on the catalog home route",
  "此路由是否显示实时汇率": "Show live exchange rates on this route",
  "商品首页已显示实时汇率": "Live exchange rates are visible on the catalog home route",
  "商品首页已隐藏实时汇率": "Live exchange rates are hidden on the catalog home route",
  "此路由已显示实时汇率": "Live exchange rates are visible on this route",
  "此路由已隐藏实时汇率": "Live exchange rates are hidden on this route",
  "商品首页组件设置保存失败": "Could not save the catalog route component setting",
  "页面组件设置保存失败": "Could not save the route component setting",
  "商家页脚与外部链接": "Merchant footer and external links",
  "展示商家自己的品牌介绍和联系入口；所有文字与跳转地址都可以自定义。":
    "Show the merchant's brand information and contact entries. All labels and destinations are customizable.",
  "正在加载前台页脚设置": "Loading storefront footer settings",
  "前台页脚设置加载失败": "Could not load storefront footer settings",
  "前台页脚设置保存失败": "Could not save storefront footer settings",
  "子账号详情": "Subaccount details",
  "子账号列表": "Subaccount list",
  "点击子账号进入详情，查看资料、价格和该账号订单":
    "Open a subaccount to review its profile, pricing, and orders.",
  "返回子账号列表": "Back to subaccounts",
  "集中查看账号资料、访问状态、价格规则和该账号提交的订单。":
    "Review account information, access status, pricing rules, and orders submitted by this subaccount.",
  "子账号经营概览": "Subaccount business overview",
  "累计订单": "Total orders",
  "本月成交": "Sales this month",
  "账号档案": "Account profile",
  "最近登录": "Last login",
  "已开放模块": "Enabled modules",
  "价格策略": "Pricing strategy",
  "当前账号价格规则": "Current account pricing rules",
  "默认加价比例": "Default markup",
  "分类规则": "Category rules",
  "SKU 特价": "SKU prices",
  "管理价格规则": "Manage pricing rules",
  "账号订单数据": "Account order data",
  "该子账号提交的订单": "Orders submitted by this subaccount",
  "该子账号尚未提交订单": "This subaccount has not submitted any orders",
  "订单提交后会在这里形成该账号自己的历史记录。":
    "Submitted orders will appear here as this account's own order history.",
  "正在读取子账号详情": "Loading subaccount details",
  "子账号详情加载失败": "Could not load subaccount details",
  "子账号不存在或已被删除": "The subaccount does not exist or has been deleted",
  "订单详情加载失败": "Could not load order details",
  "子账号权限已更新": "Subaccount permissions updated",
  "子账号删除失败": "Could not delete the subaccount",
  "子账号已删除，历史订单仍保留": "Subaccount deleted; historical orders were retained",
  "永久删除这个子账号？": "Permanently delete this subaccount?",
  "“{name}”将立即无法登录，也不能重新开通。历史订单会继续保留用于对账和追溯。":
    "{name} will immediately lose access and cannot be reactivated. Historical orders will remain available for reconciliation and traceability.",
  "删除与停用不同，此操作无法撤销。": "Unlike suspension, deletion cannot be undone.",
  "改密码": "Reset password",
  "国家": "Country",
  "前台页脚预览": "Storefront footer preview",
  "未命名分区": "Untitled section",
  "未命名链接": "Untitled link",
  "分区 {section}": "Section {section}",
  "删除分区": "Delete section",
  "分区标题": "Section title",
  "标题链接（选填）": "Title link (optional)",
  "跳转地址": "Destination",
  "删除链接": "Delete link",
  "新增链接": "Add link",
  "新增分区": "Add section",
  "保存页脚": "Save footer",
  "请填写第 {section} 个页脚分区的标题。":
    "Enter a title for footer section {section}.",
  "第 {section} 个页脚分区的标题链接格式不正确。":
    "The title link for footer section {section} is invalid.",
  "请完整填写第 {section} 个分区的第 {link} 条链接。":
    "Complete link {link} in footer section {section} with a valid label and destination.",
