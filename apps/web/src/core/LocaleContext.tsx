...
const english: Record<string, string> = {
  ...
  "历史版本": "Versions",
  "AI 辅助": "AI assistance",
  "从商品生成并归纳": "Generate from products and distill",
  "先从绑定店铺的公开商品生成问答草稿，再由 AI 从案例中归纳可复用规则。所有内容都需要人工批准。": "Generate Q&A drafts from public products in a bound store, then let AI distill reusable rules. Every item requires human approval.",
  "AI 生成商品案例": "Generate product cases",
  "总结可复用规则": "Distill reusable rules",
  "导出训练包": "Export training package",
  "导入训练包": "Import training package",
  "复制到其他智能体": "Copy to another agent",
  "选择目标智能体": "Select target agent",
  "复制案例与规则": "Copy cases and rules",
  "人工可增删改": "Human-editable",
  "训练案例": "Training cases",
  "新增案例": "New case",
  "还没有训练案例": "No training cases yet",
  "可以手工新增，也可以让 AI 根据公开商品生成一批草稿。": "Add one manually or generate a draft batch from public products with AI.",
  ...
  "先准备案例，再使用“总结可复用规则”，或由人工直接新增。": "Prepare cases, then distill reusable rules or add one manually.",
  ...
  "根据公开商品生成案例": "Generate cases from public products",
  "模型只会收到对客可见的商品字段，生成结果保存为草稿。": "The model receives customer-visible product fields only, and generated output is saved as draft.",
  "来源店铺": "Source store",
  "生成数量": "Number to generate",
  "案例语言（逗号分隔）": "Case languages (comma-separated)",
  "开始生成": "Generate",
  ...
  "案例草稿已生成": "Case drafts generated",
  "可复用规则草稿已生成": "Reusable rule drafts generated",
  ...
  "训练包已导入为草稿": "Training package imported as draft",
  "案例和规则已复制到目标智能体，状态为草稿": "Cases and rules copied to the target agent as drafts",
  "详情配置": "Configure",
  ...
  "普通 JSON 将作为知识解析；训练包 JSON 将自动导入人工训练草稿。": "Regular JSON is parsed as knowledge; training-package JSON is imported automatically as training drafts.",
  "JSON 文件格式无效，请检查编码和语法。": "The JSON file is invalid. Check its encoding and syntax.",
  "训练包已导入为草稿，请前往人工训练审核并发布。": "The training package was imported as drafts. Review and publish it in Human Training.",
  "前往人工训练": "Open Human Training",
