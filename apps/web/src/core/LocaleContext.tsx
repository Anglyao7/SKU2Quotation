...
const english: Record<string, string> = {
  ...
  "确定应用 {count} 张": "Apply {count} images",
  "重新处理这张图片": "Process this image again",
  "已载入系统默认提示词，可按需修改后再次提交。": "The system prompt is loaded; edit it before submitting again if needed.",
  "重新处理提示词": "Retry enhancement prompt",
  "修改提示词并重新生成": "Edit prompt and regenerate",
  "比例": "Ratio",
  "尺寸": "Size",
  "生成结果会先进入审核，确认后才会替换商品主图。": "Compare the results first; approved images replace the main image after you click Apply.",
  ...
  "完成后请逐张审核，通过后点击确定应用图片。": "Review each result, then click Apply to replace the main product image.",
  "全部审核通过": "Approve all",
  ...
  "直接编辑表格中的价格、数量、名称等字段，保存后才会写入本次报价。": "Edit prices, quantities, names and other fields directly in the table. Changes apply to this quote after saving.",
