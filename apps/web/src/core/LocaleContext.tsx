...
const english: Record<string, string> = {
  ...
  "公告管理": "Announcements",
  "公告": "Announcements",
  "按时间发布顶部滚动字幕或富内容弹窗，并控制访客再次看到弹窗的间隔。":
    "Schedule a top ticker or rich-content popup and control how soon visitors can see a popup again.",
  "新建公告": "New announcement",
  "全部公告": "All announcements",
  "当前展示中": "Currently active",
  "弹窗再次提醒间隔": "Popup reminder interval",
  ...
  "滚动字幕": "Ticker",
  "富内容弹窗": "Rich popup",
  "{count} 个内容块 · 每 {hours} 小时最多显示一次":
    "{count} blocks · at most once every {hours} hours",
  ...
  "暂停展示": "Pause display",
  "再次显示间隔（小时）": "Show again after (hours)",
  "前台效果预览": "Storefront preview",
  "同一浏览器看过后，至少间隔 {hours} 小时才会再次出现。":
    "After being seen in a browser, it will not appear again for at least {hours} hours.",
  ...
  "等待开始": "Scheduled",
  "已结束": "Ended",
  "请填写公告标题。": "Enter an announcement title.",
  ...
  "再次显示间隔应为 1 到 720 小时。": "The repeat interval must be between 1 and 720 hours.",
