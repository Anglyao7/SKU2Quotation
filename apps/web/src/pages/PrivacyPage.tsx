  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <section>
          <h2>二、处理目的与使用方式</h2>
          <p>上述信息仅用于展示商品、响应搜索、统计商品详情访问次数与主要访问国家、生成和下载报价草稿、联系你确认交易条件、维护账号与租户权限、预防滥用、排查故障及履行法定义务。商家看到的是按日期、商品和国家汇总的统计数据，不会通过统计接口取得访客原始 IP。我们不会把公开报价草稿直接视为已经确认的订单或正式商业承诺。</p>
        </section>
        ...
        <section>
          <h2>四、保存期限与安全措施</h2>
          <p>商品详情访问记录中的原始 IP 默认保存 60 天，期满后删除；不含原始 IP 的按日汇总访问次数可继续保存，用于商家经营趋势分析。其他信息仅在完成报价跟进、履行合同、处理争议与满足法定留存义务所必需的期间保存；目的实现且无继续保存依据后，将删除或匿名化处理。</p>
