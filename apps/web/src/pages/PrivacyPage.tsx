...
const effectiveDate = String(
  import.meta.env.VITE_PRIVACY_EFFECTIVE_DATE || "2026-07-29",
).trim();
  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <section>
          <h2>一、我们处理哪些信息</h2>
          <p>当你浏览公开商品时，我们会处理保障网站运行所必需的网络日志与安全信息。进入某一商品详情页时，系统还会记录商品、访问时间、规范化后的 IP 地址以及由受信任网络服务提供的国家或地区代码，用于向该商家提供商品访问统计；搜索、筛选与普通浏览不要求你创建账号。</p>
          <p>当你生成报价草稿时，我们会处理你主动填写的姓名、公司、邮箱或电话、报价备注，以及你选择的 SKU、数量、生成时间、提交 IP 和当时确认的隐私政策版本。请不要在备注中填写身份证件、金融账户、健康状况等与报价无关的敏感信息。</p>
          <p>商家成员登录工作台时，身份服务会处理账号标识、已验证邮箱、登录时间、会话与安全验证信息；访问权限由所属商家和角色共同决定。</p>
        </section>

        <section>
          <h2>二、处理目的与使用方式</h2>
          <p>上述信息仅用于展示商品、响应搜索、统计商品详情访问次数与主要访问国家、生成和下载报价草稿、联系你确认交易条件、维护账号与租户权限、预防滥用、排查故障及履行法定义务。商家通过统计接口看到的是按日期、商品和国家汇总的数据，不会通过该接口取得访客原始 IP；子账号前台提交报价时的 IP 仅向该商家的主账号展示，用于订单跟进与安全判断。我们不会把公开报价草稿直接视为已经确认的订单或正式商业承诺。</p>
        </section>
        ...
        <section>
          <h2>四、保存期限与安全措施</h2>
          <p>商品详情访问记录及报价提交记录中的原始 IP 默认保存 60 天，期满后删除；不含原始 IP 的按日汇总访问次数可继续保存，用于商家经营趋势分析。其他信息仅在完成报价跟进、履行合同、处理争议与满足法定留存义务所必需的期间保存；目的实现且无继续保存依据后，将删除或匿名化处理。</p>
          <p>我们采用 HTTPS、最小权限、租户隔离、数据库行级策略、登录多因素验证、访问限速与备份校验等措施降低未经授权访问、泄露、篡改或丢失的风险。</p>
        </section>
