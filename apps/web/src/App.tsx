...
const router = createBrowserRouter([{
  ...
  { path: "/privacy", element: <PrivacyPage /> },
  {
    ...
    children: [{
      ...
      children: [
        ...
        { path: "platform/translations", element: <PlatformAdminGate><PermissionGate anyOf={["product.view"]}><LanguagePackagesPage /></PermissionGate></PlatformAdminGate> },
  ...
  {
    path: "/:tenantSlug/account/:accountKey/me/orders",
    loader: storefrontLoader,
    element: <StorefrontVisitorCenterPage />,
    errorElement: <StorefrontRouteError />,
  },
