...
def get_store(
    ...
    *,
    ...
    response = PublicStoreResponse(
        ...
        prices_visible=bool(getattr(profile, "storefront_prices_visible", True)),
        ...
        popular_search_terms=_public_popular_search_terms(
            session,
            tenant_id=tenant.id,
            configured_terms=getattr(profile, "popular_search_terms", None),
        ),
    ...
    snapshot_items = [
        {
            ...
            "customer_note": getattr(item, "customer_note", None),
