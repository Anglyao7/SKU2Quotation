...
DEFAULT_HANDOFF_MESSAGES = {
    ...
    "fa": "این پرسش نیاز به بررسی تیم ما دارد و به پشتیبان انسانی ارجاع داده شد.",
...
DEFAULT_HANDOFF_OFFER_MESSAGES = {
    ...
    "fa": "این پرسش نیاز به بررسی تیم ما دارد. برای دریافت کمک انسانی، گزینه «تماس با پشتیبان» را در پایین انتخاب کنید.",
...
ASSISTANCE_FALLBACKS = {
    ...
    "fa": "به کمک ادامه می‌دهم. هنوز اطلاعات قابل اعتماد کافی برای تأیید یک محصول یا نتیجه مشخص ندارم؛ کاربرد، اندازه، جنس، بودجه یا کد محصول را بفرستید تا جستجو دقیق‌تر شود.",
