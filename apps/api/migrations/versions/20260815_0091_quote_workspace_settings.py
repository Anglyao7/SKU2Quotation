...
Revision ID: 20260815_0091
Revises: 20260815_0090
"""
...
revision = "20260815_0091"
down_revision = "20260815_0090"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    columns = (
        ...
        else {column["name"] for column in sa.inspect(bind).get_columns("public_quote_drafts")}
    )
