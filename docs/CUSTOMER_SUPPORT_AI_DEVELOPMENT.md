...
启用/关闭、多语言、引用和人工接管），数据库版本为 `20260809_0060`。当前实现入口如下：
...
`20260809_0059_support_ai_configuration.py`、`20260809_0060_support_ai_store_profiles.py`。
后续章节同时保留长期目标；标为 Phase 5/6
的能力不属于本次 v1 自动回答范围。
